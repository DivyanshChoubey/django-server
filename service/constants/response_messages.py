class ResponseMessages:
    ...
    PR_LINK_NOT_FOUND = "PR Link not found."
    CRON_EXECUTE_SUCCESS = "Daily report reminder cron executed successfully."
    INVALID_RUN_MODE = "run mode is invalid please use specific_time OR interval."
    NO_USER_REQUIRE_REMINDER = "No users found for reminder email."
